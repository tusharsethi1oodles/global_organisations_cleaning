...
# def mark_duplicates(input_file,output_file):
...
#                 jth_organisation_name=str(df.at[i,'organisation_name'])
                
#                 if not ith_organisation_name or not jth_organisation_name:
#                     print('one of the row is empty...')
#                     continue
...
#                     print('these two name are similar: \n')
#                     print(f"{i}th row's name: {df.at[i,'organisation_name']}")
#                     print(f"{j}th row's name: {df.at[j,'organisation_name']}")
#                     print('\n')
...
# mark_duplicates(input_file,output_file)
